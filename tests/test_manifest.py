...
def test_synthetic_scene_number_determines_view():
    meta = video_metadata(Path("data/syn/ground/Halt/Scene26_386_Halt_4_2_2022_15_1_38.mp4"), "syn")
...
def test_real_videos_have_no_scene_viewpoint():
    meta = video_metadata(Path("data/real/ground/MoveForward/S04_10m_ground_label4_start4837.mp4"), "real")
...
def test_second_session_maps_to_the_same_subject():
    ...
    meta = video_metadata(Path("data/real/ground/FollowMe/S04b_10m_ground_label6_start2098.mp4"), "real")
